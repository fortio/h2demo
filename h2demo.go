...
<p>Recovered from <a href="https://go.googlesource.com/net/+/69e39bad7dc2bbb411fa35755c46020969029fa7/http2/h2demo/>https://go.googlesource.com/net/+/69e39bad7dc2bbb411fa35755c46020969029fa7/http2/h2demo</a>
then modified to minimize dependencies and make it run locally</p>
...
func main() {
	var srv http.Server
	flag.BoolVar(&http2.VerboseLogs, "verbose", true, "Verbose HTTP/2 debugging.")
	flag.Parse()
	srv.Addr = *httpsAddr
